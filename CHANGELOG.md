...
- Offline pack verify CLI (#70 / #28): `adventurectl pack verify` wraps catalog/layout/`content_hash` checks and prints a layer fingerprint; `--json` / `--allow-legacy-seeds`; `scripts/check_pack.py` shares the same report helper
