...
- Skardu evaluation seed + corpus CI (#56 / #9): provisional curator labels under `evaluation/skardu/`; `validate_place_label_corpus` gate in `tests/test_evaluation_labels.py`; RFC-0002 Accepted (infra; regional fill ongoing)
