...
- Geofabrik dated extract pins (#60): `allow_latest: false`, optional `geofabrik_md5` / `geofabrik_sha256` verify (including cache reuse); `skardu_v1` pinned to `pakistan-260801`
